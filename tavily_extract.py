...
#         self.tavily_client = AsyncTavilyClient(api_key="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") # Prod key tied to corp account, 1000 rpmin and 19000 rpmonth
...
#             {"query": "product information UPC " + upc + "", "search_depth": "advanced", "max_results": 2, "include_images": include_images, "exclude_domains": [("www.acehardware.com")]},
